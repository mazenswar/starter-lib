		...
		>
			<div className="block__content container">
				...
				<div className="card-grid__header">
					<h2 id="card-grid-heading">{cardGrid.heading}</h2>
					{cardGrid.subheading && (
						<p className="card-grid__sub">{cardGrid.subheading}</p>
					)}
				</div>
				...
				{cardGrid.cta && (
					<div className="card-grid__footer">
						<Button
							text={cardGrid.cta.text}
							href={cardGrid.cta.href}
							variant={cardGrid.cta.variant ?? "secondary"}
						/>
					</div>
				)}
			</div>
